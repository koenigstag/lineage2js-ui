...
export declare type EPairActionRequest = {
  type: string;
  data: { requesterName: string; actionId: number };
  once: boolean;
};
...
export declare type OnPairActionRequestEvent = [
  "PairActionRequest",
  (e: EPairActionRequest) => void
];
