...
export const LANG_EN_US: LangDictionary = {
  ...
  tooltip: {
    ...
    idLabel: "ID: {id}",
    pAtkLabel: "P. Atk. {value}",
    mAtkLabel: "M. Atk. {value}",
    pDefLabel: "P. Def. {value}",
    mDefLabel: "M. Def. {value}",
    shieldDefLabel: "Shield Def. {value}",
    shieldRateLabel: "Shield Def. Rate {value}",
    evasionLabel: "Evasion {value}",
    atkSpdLabel: "Atk. Spd. {value}",
    critLabel: "Critical {value}",
    rangeLabel: "Range {value}",
    accuracyLabel: "Accuracy {value}",
    shotsLabel: "Shots {soulshots}/{spiritshots}",
    mpConsumeLabel: "MP Consume {value}",
    weightLabel: "Weight {value}",
    augmentedLabel: "Augmented",
    attributeLabel: "Attribute: {element} +{value}",
    elements: {
      fire: "Fire",
      water: "Water",
      wind: "Wind",
